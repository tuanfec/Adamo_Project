  ...
  return (
    <div className="flex flex-col gap-4">
      <div className="w-2/7 flex flex-col gap-2">
        ...
        <div className="text-sm mt-4 text-[#5E6D77] font-medium">
      ...
      <div className="w-full">
        <div>
          {lineSeparation(data.description).map((line, index) => (
            <div className="mt-4 italic text-[#1E1E1ECC]" key={index}>
              {line}
            </div>
          ))}
        </div>
        <div className="flex flex-col gap-1 mt-5 text-[#1E1E1ECC]">
