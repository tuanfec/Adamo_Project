...
export const EmailSubcription: React.FC = () => {
  return (
    <div className="flex lg:flex-row md:flex-row flex-col items-center justify-center lg:mx-0 md:mx-10 ">
      <div className="inline-block w-full lg:text-4xl text-xl font-medium mb-2">
      ...
      <div className="w-full flex flex-row lg:items-end lg:justify-end justify-center gap-4 ">
