...
export const ButtonMode = () => {
  ...
  return (
    <label className="inline-flex items-center relative mr-13">
      <input className="peer hidden" type="checkbox" checked={isDarkMode} />
      <div
        onClick={handleToggleTheme}
        className="
                relative w-[100px] h-[44px] bg-white peer-checked:bg-zinc-500 rounded-full
                ...
                after:rounded-full after:top-[5px] after:left-[8px]
                 active:after:w-[50px]
                peer-checked:after:left-[93px] peer-checked:after:translate-x-[-100%]
